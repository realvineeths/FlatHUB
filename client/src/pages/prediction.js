...
function Prediction() {
    ...
    console.log(queryconst,queryarea,queryroom,querycity);
  ...
  <>
    ...
    <div className='card cardisp1'>

    <h5 class="item-card-title mt-3 mb-3">The price  predicted is:</h5>
    <h7>₹{queryresult} Lakh Only</h7>
    </div>


        <div>
        <form onSubmit={handleSubmit} className='formpred'>
        ...
        {/* <div className="form-group">
            ...
            <textarea className="form-control" rows="5" placeholder="Textarea"></textarea>
        </div> */}
